 ...
 * @date	3:44:11 2012-12-11
 * @version	$Id: Zh2Pinyin.php 234 2013-01-21 07:08:11Z gangzong $
...
class Zh2Pinyin
{
	...
	{
		preg_match("/^[a-zA-Z\b\s\-\_]+/", $_String, $matches);
		$modify = isset($matches[0]) ? $matches[0] : null;
		...
		if ($_Res !== $_String) {
			// 非英文，以及英文开头的字母修正
			return $modify . preg_replace("/[^a-z0-9]*/", '', $_Res);
		} else {
			// 全英文
			return $_Res;
		}
