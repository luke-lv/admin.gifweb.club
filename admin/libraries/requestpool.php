 ...
 * @date	16:13:52 2012-12-17
 * @version	$Id: RequestPool.php 11 2012-12-19 03:24:50Z gangzong $
...
class RequestPool
{
	...
	public static function attach(request $http_request)
	{
	...
	public static function send($force_all = false)
	{
		...
		do {
			...
			while ($rst = curl_multi_info_read(self::$mh, $queue_point)) {
				$curl_id = request::fetch_curl_id($rst['handle']);
	...
	{
		$ch = curl_init();
		$curl_id = request::fetch_curl_id($ch);
