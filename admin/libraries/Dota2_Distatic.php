...
class Dota2_Distatic
{
	protected static $instance = null;
	
	protected $file;

	const DATA_ROOT_PATH = "/data1/www/htdocs/admin.games.sina.com.cn/data/";
	
	const FILE_ROOT_PATH = "t_img/dota2/images/avatar/";
	...
	public function dist($file = null)
	{
		...
		$file = self::FILE_ROOT_PATH . trim(basename($this->file), "/");
