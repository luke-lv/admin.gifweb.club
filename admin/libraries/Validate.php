 ...
 * @date	15:51:02 2012-12-11
 * @version	$Id: Validate.php 11 2012-12-19 03:24:50Z gangzong $
...
class Validate
{
	...
	/**
	 * check is or not exists badword
	 * @param type $string
	 * @return boolean
	 */
	...
	public static function username($username)
	{
		...
		if (self::badword($username) || !preg_match("/^[a-zA-Z0-9_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]+$/", $username)) {
			return false;
