 ...
 * @date	1:14:18 2017-05-01
 * @version	$Id: User.php 13 2017-05-01 07:10:10Z songqinglu $
 * @desc	This guy is so lazy that he doesn't leave anything.
 */

class Gifcontent_type_model extends MY_Model
{

	protected $_table = 'gifweb_content_type';
	protected $_pk = 'id';
